...
<head>
    ...
    <style>
        ...
        button {
            ...
            margin: 10px;
            cursor: pointer;
            transition: all 0.2s; /* Añadir transición suave */
        }
        #celebration {
            display: none;
            margin-top: 20px;
        ...
        .hearts {
            ...
            width: 100%;
            height: 200px;
            background: url('https://img1.picmix.com/output/stamp/normal/8/4/8/7/327848_294cb.gif') no-repeat center;
...
<body>
    ...
    <p>Rut, ¿Quisieras ser mi San Valentín?</p>
    <button id="yesBtn">Sí</button>
    <button id="noBtn">No</button>

    <div id="celebration" class="hearts"></div>

    <script>
        const messages = [
            "Ya no me quieres?",
            "¿Segura?",
            "Yo sé que sí, no te hagas la loca.",
            "De mí no te escapas.",
            "Ámame preciosa.",
            "No hay chance.",
            "Sigue intentando.",
